...
In \S\ref{sec:segmentation-ipfconstruction}, I presented two separate algorithms for constructing partition forests -- the \emph{volume-at-once} method and the \emph{subvolume} method.
