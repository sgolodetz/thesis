...
When compared with ADF (as in \S\ref{?}), SVGF produces clearly inferior end results, as one might expect from such a simple technique. However, SVGF does help to improve the resulting segmentation, as witnessed by its successful use in \emph{centipede}. Moreover, it has a few advantages over ADF:
%
\begin{itemize}
