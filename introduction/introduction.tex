...
\begin{stusubfig}{p}
	...
	{\includegraphics[width=.6\linewidth]{introduction/introduction-millipede-seg-windows.png}}%
	%
	\\
	%
	\subfigure[\emph{millipede} running on Linux (Ubuntu)]
	{\includegraphics[width=.6\linewidth]{introduction/introduction-millipede-seg-linux.png}}%
	%
	\\
	%
	\subfigure[\emph{millipede} running on Mac OS X (Snow Leopard)]
	{\includegraphics[width=.6\linewidth]{introduction/introduction-millipede-seg-macosx.png}}%
