...
%---
\stufigex{height=8cm}{introduction/introduction-labelledabdominalscan.png}{An example CT scan of the abdomen, with some of the key features labelled.}{fig:introduction-labelledabdominalscan}{t}
%---
