...
The user interface for non-sibling node merging is very simple, as illustrated in Figure~\ref{?}. The user selects some nodes, then clicks a menu item to merge them.
