...
\begin{stusubfig}{p}
	...
	\\
	\subfigure[Initial layer $1$ graph]{\includegraphics[width=.25\linewidth]{ipfs/ipfs-forest-unzipping-a-graph1.png}}%
	\hspace{8mm}%
	\subfigure[Initial layer $2$ graph]{\includegraphics[width=.25\linewidth]{ipfs/ipfs-forest-unzipping-a-graph2.png}}%
	\hspace{8mm}%
	\subfigure[Initial layer $3$ graph]{\includegraphics[width=.25\linewidth]{ipfs/ipfs-forest-unzipping-a-graph3.png}}%
	\\
	\subfigure[Resulting layer $1$ graph]{\includegraphics[width=.25\linewidth]{ipfs/ipfs-forest-unzipping-b-graph1.png}}%
	\hspace{8mm}%
	\subfigure[Resulting layer $2$ graph]{\includegraphics[width=.25\linewidth]{ipfs/ipfs-forest-unzipping-c-graph2.png}}%
	\hspace{8mm}%
	\subfigure[Resulting layer $3$ graph]{\includegraphics[width=.25\linewidth]{ipfs/ipfs-forest-unzipping-d-graph3.png}}%
...
%---
\begin{stusubfig}{p}
	\subfigure[Layer 1 before unzipping]{\includegraphics[width=.3\linewidth]{ipfs/ipfs-forest-unzipping-gui-a.png}}%
	\hspace{8mm}%
	\subfigure[Layer 2 before unzipping]{\includegraphics[width=.3\linewidth]{ipfs/ipfs-forest-unzipping-gui-b.png}}%
	\\
	\subfigure[Layer 3 before unzipping]{\includegraphics[width=.3\linewidth]{ipfs/ipfs-forest-unzipping-gui-c.png}}%
	\hspace{8mm}%
	\subfigure[Select a node to unzip]{\includegraphics[width=.3\linewidth]{ipfs/ipfs-forest-unzipping-gui-d.png}}%
	\\
	...
	\\
	\subfigure[Layer 2 after unzipping]{\includegraphics[width=.3\linewidth]{ipfs/ipfs-forest-unzipping-gui-g.png}}%
	\hspace{8mm}%
	\subfigure[Layer 3 after unzipping]{\includegraphics[width=.3\linewidth]{ipfs/ipfs-forest-unzipping-gui-h.png}}%
...
%---
\begin{stusubfig}{p}
	\subfigure[Initial hierarchy]{\includegraphics[width=.45\linewidth]{ipfs/ipfs-forest-zipping-a-hierarchy.png}}%
	\hspace{8mm}%
	\subfigure[After merging layer $3$ nodes]{\includegraphics[width=.45\linewidth]{ipfs/ipfs-forest-zipping-b-hierarchy.png}}%
	\\
	\subfigure[After merging layer $2$ nodes]{\includegraphics[width=.45\linewidth]{ipfs/ipfs-forest-zipping-c-hierarchy.png}}%
	\hspace{8mm}%
	\subfigure[After merging layer $1$ nodes]{\includegraphics[width=.45\linewidth]{ipfs/ipfs-forest-zipping-d-hierarchy.png}}%
	\\
	\subfigure[Initial layer $1$ graph]{\includegraphics[width=.25\linewidth]{ipfs/ipfs-forest-zipping-a-graph1.png}}%
	\hspace{8mm}%
	\subfigure[Initial layer $2$ graph]{\includegraphics[width=.25\linewidth]{ipfs/ipfs-forest-zipping-a-graph2.png}}%
	\hspace{8mm}%
	\subfigure[Initial layer $3$ graph]{\includegraphics[width=.25\linewidth]{ipfs/ipfs-forest-zipping-a-graph3.png}}%
	\\
	\subfigure[Resulting layer $1$ graph]{\includegraphics[width=.25\linewidth]{ipfs/ipfs-forest-zipping-d-graph1.png}}%
	\hspace{8mm}%
	\subfigure[Resulting layer $2$ graph]{\includegraphics[width=.25\linewidth]{ipfs/ipfs-forest-zipping-c-graph2.png}}%
	\hspace{8mm}%
	\subfigure[Resulting layer $3$ graph]{\includegraphics[width=.25\linewidth]{ipfs/ipfs-forest-zipping-b-graph3.png}}%
