...
%---
\begin{stusubfig}{p}
	\subfigure[Selected nodes in multiple layers]{\includegraphics[width=.4\linewidth]{ipfs/ipfs-selection-hierarchicalstructure-a.png}}%
	\hspace{4mm}%
	\subfigure[Corresponding pixel selection]{\includegraphics[width=.4\linewidth]{ipfs/ipfs-selection-hierarchicalstructure-b.png}}%
