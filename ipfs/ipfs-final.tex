...
\item Let $\ell_{\mbox{min}} = \min_{i=1}^k \ell_i$ and check the precondition that $\ell_{\mbox{min}} > 0$, i.e.~that none of the nodes to be merged is in the lowest layer of the hierarchy.
