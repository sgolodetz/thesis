...
\hline\hline
Thresholding & \textcolor{green}{High} & \textcolor{red}{Low} & \textcolor{red}{Low} & \textcolor{green}{No} & \textcolor{green}{Low} & \textcolor{gold}{Mid} & \textcolor{red}{Hard} & \textcolor{red}{No} & \textcolor{red}{No} \\
...
Watershed from Markers & \textcolor{gold}{Mid} & \textcolor{green}{High} & \textcolor{green}{High} & \textcolor{green}{No} & \textcolor{red}{High} & \textcolor{red}{Low} & \textcolor{red}{Hard} & \textcolor{red}{No} & \textcolor{green}{Yes} \\
...
Snakes & \textcolor{gold}{Mid} & \textcolor{green}{High} & \textcolor{red}{Low} & \textcolor{green}{No} & \textcolor{red}{High} & \textcolor{red}{Low} & \textcolor{green}{Easy} & \textcolor{red}{No} & \textcolor{green}{Yes} \\
Level Sets & \textcolor{gold}{Mid} & \textcolor{green}{High} & \textcolor{gold}{Mid} & \textcolor{green}{No} & \textcolor{red}{High} & \textcolor{red}{Low} & \textcolor{gold}{Mid} & \textcolor{red}{No} & \textcolor{green}{Yes?} \\
...
Clustering & \textcolor{green}{High} & \textcolor{red}{Low} & ? & \textcolor{green}{No} & \textcolor{green}{Low} & \textcolor{gold}{Mid} & \textcolor{red}{Hard} & \textcolor{red}{No?} & \textcolor{red}{No} \\
Normalized Cuts & \textcolor{green}{High} & \textcolor{red}{Low} & \textcolor{green}{High} & \textcolor{green}{No} & \textcolor{green}{Low} & \textcolor{gold}{Mid} & \textcolor{red}{Hard} & \textcolor{green}{Yes} & \textcolor{red}{No?}
\end{tabular}
\end{center}
\caption{A comparison of available segmentation methods}
\label{TODO}
