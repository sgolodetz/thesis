...
Normalized Cuts & \textcolor{green}{High} & \textcolor{gold}{Mid} & \textcolor{green}{High} & \textcolor{green}{No} & \textcolor{green}{Low} & \textcolor{gold}{Mid} & \textcolor{red}{Hard} & \textcolor{green}{Yes} & \textcolor{green}{Yes}
\end{tabular}
\end{center}
\caption{A comparison of available segmentation methods}
