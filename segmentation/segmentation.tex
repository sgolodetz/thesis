...
\begin{stusubfig}{p}
	...
	{\hspace{4mm}\includegraphics[height=5.8cm]{segmentation/segmentation-watershed-adfexample-unsmoothedgm.png}\hspace{4mm}}%
	%
	\hspace{8mm}%
	%
	\subfigure[Gradient magnitude of the smoothed image]
	{\hspace{4mm}\includegraphics[height=5.8cm]{segmentation/segmentation-watershed-adfexample-smoothedgm.png}\hspace{4mm}}%
	%
	\\
	%
