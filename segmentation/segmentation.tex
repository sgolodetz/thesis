...
\stufigex{width=10cm, height=10cm}{todo.png}{TODO}{fig:segmentation-watershed-concept}{t}
%---
...
\begin{stusubfig}{p}
	...
	{\includegraphics[width=.25\linewidth]{segmentation/segmentation-watershed-connectivity-4.png}}%
	%
	\hspace{4mm}%
	%
	\subfigure[8-connected (2D)]
	{\includegraphics[width=.25\linewidth]{segmentation/segmentation-watershed-connectivity-8.png}}%
	%
	\hspace{4mm}%
	%
	\subfigure[6-connected (3D)]
	{\includegraphics[width=.4\linewidth]{segmentation/segmentation-watershed-connectivity-6.png}}%
