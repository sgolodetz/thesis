...
\stufigex{width=15cm, height=24cm}{todo.png}{The goal of the IPF construction process}{fig:segmentation-ipfconstruction-goal}{p}
%---
...
% (a) Original (3x3) image with leaf layer RAG
% (b) Watershed labelling
% (c) Forest (showing edges added)
% (d) Lowest branch layer RAG (superimposed on original image)

\begin{stusubfig}{p}
	\subfigure[An example image and its RAG]
	{\includegraphics[height=6cm]{todo.png}}%
	%
	\hspace{4mm}%
	%
	\subfigure[The watershed labelling]
	{\includegraphics[height=6cm]{todo.png}}%
	%
	\\
	%
	\subfigure[The lowest two layers of the IPF]
	{\includegraphics[height=6cm]{todo.png}}%
	%
	\hspace{4mm}%
	%
	\subfigure[The lowest branch layer and its RAG]
	{\includegraphics[height=6cm]{todo.png}}%
...
\begin{stusubfig}{p}
	...
	\subfigure[After the second waterfall iteration]
	{\includegraphics[height=6cm]{todo.png}}%
\caption{Constructing the higher layers of the IPF}
