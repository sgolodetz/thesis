...
\begin{figure}[t]
\begin{center}
	\subfigure[The edge under consideration is not the unique lowest edge]{\includegraphics[height=6cm]{segmentation/segmentation-waterfall-nichollscases-a.png}}%
	\hspace{4mm}%
	\subfigure[The edge under consideration is the unique lowest edge]{\includegraphics[height=6cm]{segmentation/segmentation-waterfall-nichollscases-b.png}}%
\end{center}
...
\label{fig:segmentation-waterfall-nichollscases}
\end{figure}
%---
