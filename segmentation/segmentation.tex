...
\begin{stusubfig}{p}
	\subfigure[An image]
	{\includegraphics[height=6cm]{segmentation/segmentation-watershed-regionbasincorrespondence-a.png}}%
	%
	\hspace{4mm}%
	%
	\subfigure[The corresponding discrete landscape]
	{\includegraphics[height=6cm]{segmentation/segmentation-watershed-regionbasincorrespondence-b.png}}%
	%
	\\
	%
	\subfigure[The image after watershed segmentation]
	{\includegraphics[height=6cm]{segmentation/segmentation-watershed-regionbasincorrespondence-c.png}}%
	%
	\hspace{4mm}%
	%
	\subfigure[The landscape after watershed segmentation]
	{\includegraphics[height=6cm]{segmentation/segmentation-watershed-regionbasincorrespondence-d.png}}%
...
\begin{stusubfig}{p}
		\subfigure[A sample medical image (courtesy of the Churchill Hospital, Oxford)]
	{\includegraphics[height=8cm]{segmentation/segmentation-watershed-smoothedimage-a.png}}%
	%
	\hspace{4mm}%
	%
	\subfigure[The image after smoothing with a Gaussian filter ($\sigma^2 = 5$)]
	{\includegraphics[height=8cm]{segmentation/segmentation-watershed-smoothedimage-b.png}}%
