...
\begin{stusubfig}{p}
	...
	\\
	%
	\subfigure[Gradient magnitude of the unsmoothed image \stuhl{(after equalising histogram)}]
	{\hspace{4mm}\includegraphics[height=5.8cm]{segmentation/segmentation-watershed-adfexample-unsmoothedgm-eh.png}\hspace{4mm}}%
	%
	\hspace{8mm}%
	%
	\subfigure[Gradient magnitude of the smoothed image \stuhl{(after equalising histogram)}]
...
In this chapter, we saw how to generate IPFs from medical images using the morphological watershed and waterfall transforms, \stuhl{thereby accounting for the third and fourth contributions claimed in Chapter~\ref{chap:introduction}:
%
\begin{enumerate}
\setcounter{enumi}{2}
