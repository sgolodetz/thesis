...
Since representing entities hierarchically is a fundamental way in which we, as humans, seek to manage the inherent complexity of the world around us, partition hierarchy usage is ubiquitous in computer science. The varied contexts in which partition hierarchies can be used, to name but a few, include hierarchical pathfinding, image representation, team organisation \cite{?} and world representation \cite{finkel74,fuchs80}. Each of these is now discussed in more detail.
