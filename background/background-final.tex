...
%---
\stufigex{width=16cm, height=8cm}{todo.png}{A graph and its corresponding transition table -- each table entry $t_{sd}$ stores the node after $s$ on the optimal path between $s$ and $d$}{fig:background-partitionhierarchies-pathfinding-transitiontable}{p}
%---
