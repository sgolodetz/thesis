...
\begin{stusubfig}{p}
	...
	{\includegraphics[height=.4\linewidth]{background/background-segmentation-thresholding-binaryexample-a.png}}%
	%
	\hspace{4mm}%
	%
	\subfigure[The thresholded image]
	{\includegraphics[height=.4\linewidth]{background/background-segmentation-thresholding-binaryexample-c.png}}%
	%
	\hspace{4mm}%
	%
	\subfigure[The image histogram and threshold at grey value $125$]
	{\includegraphics[width=.8\linewidth, height=.3\linewidth]{todo.png}}%
...
\begin{stusubfig}{p}
	...
	{\includegraphics[height=.4\linewidth]{background/background-segmentation-thresholding-inaccurate-a.png}}%
	%
	\hspace{4mm}%
	%
	\subfigure[Conversely, segmenting it with a threshold of $75$ leads to oversegmentation]
	{\includegraphics[height=.4\linewidth]{background/background-segmentation-thresholding-inaccurate-b.png}}%
...
% TODO: fig:background-segmentation-regiongrowing-process
...
%---
\stufigex{height=8cm}{background/background-segmentation-levelsets-uniformgrid.png}{Approximating a function $\psi(\mathbf{x},t)$ with a discrete, uniformly-spaced grid (note that the time superscripts on the grid values are not shown)}{fig:background-segmentation-levelsets-uniformgrid}{p}
%---
...
%---
\stufigex{height=8cm}{background/background-segmentation-levelsets-initialfunction.png}{Generating the initial function from the zero contour specified by the user (in red)}{fig:background-segmentation-levelsets-initialfunction}{p}
%---
