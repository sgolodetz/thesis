...
%---
\stufigex{height=5cm}{segmentation-watershed-connectedness.png}{4-connected pixels are only connected to their horizontal and vertical neighbours, whereas 8-connected ones are connected to their diagonal neighbours as well}{fig:segmentation-watershed-connectedness}{t}
%---
...
%---
\stufigex{height=7cm}{segmentation-watershed-steepestdescent.png}{The flow direction at a point is ambiguous if it has more than one path of steepest descent}{fig:segmentation-watershed-steepestdescent}{t}
%---
...
\begin{figure}[t]
\begin{center}
	\subfigure[The `intuition' is to raise plateau pixels by their distance from the edge]{\includegraphics[width=.45\linewidth]{segmentation-watershed-plateau1.png}}%
	\hspace{4mm}%
	\subfigure[Doing this na\"ively can change the height ordering of the pixels in the image]{\includegraphics[width=.45\linewidth]{segmentation-watershed-plateau2.png}}%
	\hspace{4mm}%
	\subfigure[This can be fixed by spreading the landscape out prior to raising the pixels]{\includegraphics[width=.45\linewidth]{segmentation-watershed-plateau3.png}}%
\end{center}
...
\begin{figure}[t]
\begin{center}
	\subfigure[The original image]{\includegraphics[height=4cm]{segmentation-watershed-example1.png}}%
	\hspace{4mm}%
	\subfigure[The lower-complete image]{\includegraphics[height=4cm]{segmentation-watershed-example2.png}}%
	\hspace{4mm}%
	\subfigure[The arrows on each pixel]{\includegraphics[height=4cm]{segmentation-watershed-example3.png}}%
	\hspace{4mm}%
	\subfigure[The final labelling]{\includegraphics[height=4cm]{segmentation-watershed-example4.png}}%
\end{center}
...
%---
\stufigex{width=\linewidth}{segmentation-waterfall-hierarchy.jpg}{The waterfall transform produces a hierarchical sequence of partitions of an image, typically starting from the result of the watershed transform (far left). The final partition will eventually be a single region if the waterfall is run to completion, although this is not usually done.}{fig:segmentation-waterfall-hierarchy}{t}
%---
...
%---
\stufigex{height=7cm}{segmentation-waterfall-rag.jpg}{A set of regions (left) and their region adjacency graph (right) - note that edges to the surrounding region (in beige) are not shown to make things clearer.}{fig:segmentation-waterfall-rag}{t}
%---
...
\subsubsection{Step 2: Edge Elision}
...
\subsubsection{Step 4: Rebuilding the MST}
