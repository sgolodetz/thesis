...
Having first identified the spine, identifying the spinal cord becomes a much simpler task. The intuition is to search for regions within the $x-y$ bounding box of the spine (see Figure~\ref{?}) that:
%
\begin{itemize}
