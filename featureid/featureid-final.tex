...
\begin{stusubfig}{p}
	...
	{\hspace{8mm}\includegraphics[height=6cm]{featureid/featureid-3d-spinalcordidentification-transparent-BT-2-60-80.png}\hspace{8mm}}%
	%
	\hspace{4mm}%
	%
	\subfigure[Series BT-2 (Slices 60--80), Spinal Cord Only]
	{\hspace{12mm}\includegraphics[height=6cm]{featureid/featureid-3d-spinalcordidentification-solid-BT-2-60-80.png}\hspace{12mm}}%
	%
	\\
	%
	\subfigure[Series SD-2 (Slices 70--90), Spine and Spinal Cord]
	{\hspace{16mm}\includegraphics[height=6cm]{featureid/featureid-3d-spinalcordidentification-transparent-SD-2-70-90.png}\hspace{16mm}}%
	%
	\hspace{4mm}%
	%
	\subfigure[Series SD-2 (Slices 70--90), Spinal Cord Only]
	{\hspace{20mm}\includegraphics[height=6cm]{featureid/featureid-3d-spinalcordidentification-solid-SD-2-70-90.png}\hspace{20mm}}%
	%
	\\
	%
	\subfigure[Series EJ-2 (Slices 20--40), Spine and Spinal Cord]
	{\hspace{12mm}\includegraphics[height=6cm]{featureid/featureid-3d-spinalcordidentification-transparent-EJ-2-20-40.png}\hspace{12mm}}%
	%
	\hspace{4mm}%
	%
	\subfigure[Series EJ-2 (Slices 20--40), Spinal Cord Only]
	{\hspace{20mm}\includegraphics[height=6cm]{featureid/featureid-3d-spinalcordidentification-solid-EJ-2-20-40.png}\hspace{20mm}}%
