...
%---
\stufigex{height=9cm}{featureid/featureid-3d-spinalcordidentification-region.png}{The spinal cord (selected, in red) should lie well within the (yellow) bounding box of the regions identified as the spine}{fig:featureid-3d-spinalcordidentification-region}{h}
%---

\noindent Having first identified the spine, identifying the spinal cord becomes a much simpler task. The intuition is to search for regions well within the $x-y$ bounding box of the spine (see Figure~\ref{fig:featureid-3d-spinalcordidentification-region}) that:
%
\begin{itemize}
...
\item Have a mean grey value $\le 140$ (the spinal cord appears much darker on the CT scans than the vertebrae surrounding it).
\item Have a voxel count of between $300$ and $1000$ voxels per (axial) slice.

\end{itemize}
%
Regions which satisfy these criteria are unmarked as spine (if necessary) and marked as spinal cord. Unlike the spine identifier, the spinal cord identifier clearly cannot be run in isolation, but it is possible to visualize the results of spinal cord identification by running both the spine and spinal cord identifiers and then either rendering the spinal cord on its own, or rendering the spine as transparent. As illustrated in Figure~\ref{fig:featureid-3d-spinalcordidentification-results}, the identifier is quite robust, and able to automatically identify the spinal cord in a number of different image series. There is, however, definitely room for further work to improve the detailed contour of the cord -- this could perhaps be done by using the automatic result produced thus far to initialise a level sets approach.
...
%---
\begin{stusubfig}{p}
	\subfigure[Series BT-2 (Slices 60--80), Spine and Spinal Cord]
	{\hspace{16mm}\includegraphics[height=6cm]{featureid/featureid-3d-spinalcordidentification-transparent-BT-2-60-80.png}\hspace{16mm}}%
	%
	\hspace{4mm}%
	%
	\subfigure[Series BT-2 (Slices 60--80), Spinal Cord Only]
	{\hspace{20mm}\includegraphics[height=6cm]{featureid/featureid-3d-spinalcordidentification-solid-BT-2-60-80.png}\hspace{20mm}}%
	%
	\\
	%
	\subfigure[Series SD-2 (Slices 70--90), Spine and Spinal Cord]
	{\hspace{20mm}\includegraphics[height=6cm]{featureid/featureid-3d-spinalcordidentification-transparent-SD-2-70-90.png}\hspace{20mm}}%
	%
	\hspace{4mm}%
	%
	\subfigure[Series SD-2 (Slices 70--90), Spinal Cord Only]
	{\hspace{24mm}\includegraphics[height=6cm]{featureid/featureid-3d-spinalcordidentification-solid-SD-2-70-90.png}\hspace{24mm}}%
	%
	\\
	%
	\subfigure[Series EJ-2 (Slices 20--40), Spine and Spinal Cord]
	{\hspace{16mm}\includegraphics[height=6cm]{featureid/featureid-3d-spinalcordidentification-transparent-EJ-2-20-40.png}\hspace{16mm}}%
	%
	\hspace{4mm}%
	%
	\subfigure[Series EJ-2 (Slices 20--40), Spinal Cord Only]
	{\hspace{24mm}\includegraphics[height=6cm]{featureid/featureid-3d-spinalcordidentification-solid-EJ-2-20-40.png}\hspace{24mm}}%
\caption{The results of running spine and spinal cord identification on slices from three different image series}
\label{fig:featureid-3d-spinalcordidentification-results}
\end{stusubfig}
%---
...
\begin{stusubfig}{p}
	\subfigure[Series BT-2 (Slices 60--80)]
	{\includegraphics[height=6cm]{featureid/featureid-3d-ribsidentification-BT-2-60-80.png}}%
	%
	\hspace{4mm}%
	%
	\subfigure[Series SD-2 (Slices 50--70)]
	{\includegraphics[height=6cm]{featureid/featureid-3d-ribsidentification-SD-2-50-70.png}}%
	%
	\\
	%
	\subfigure[Series MC-2 (Slices 80--100)]
	{\includegraphics[height=6cm]{featureid/featureid-3d-ribsidentification-MC-2-80-100.png}}%
	%
	\hspace{4mm}%
	%
	\subfigure[Series EJ-2 (Slices 1--21)]
	{\includegraphics[height=6cm]{featureid/featureid-3d-ribsidentification-EJ-2-1-21.png}}%
\caption{The results of running spine, spinal cord and ribs identification on slices from four different image series}
...
\caption{The results of running spine, spinal cord and aorta identification on slices from three different image series}
...
\caption{The results of running spine, spinal cord and kidney identification on slices from five different image series}
