...
\noindent TODO (remember to mention that non-complete kidneys, e.g.~those with tumours on, are particularly vulnerable to being missed -- an example is the EB result, where one kidney has been perfectly identified and the other has been completely missed)
