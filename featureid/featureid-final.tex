...
%---
\stufigex{height=7.5cm}{featureid/featureid-3d-aortaidentification-region.png}{The spatial constraints for aorta seeds -- the seed's left-hand side must lie between the red lines, and the top of the spine (represented by the green line) must lie between the top of the seed and $20$ voxels below the bottom of it}{fig:featureid-3d-aortaidentification-region}{h}
%---
