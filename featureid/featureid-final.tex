...
%---
\stufigex{height=9cm}{featureid/featureid-3d-aortaidentification-region-overlay.png}{The spatial constraints for aorta seeds -- they (a) must lie at least partly in the small, green box just above the spine, (b) may lie partly in the boxes marked in yellow, and (c) must not lie below or to the left of the red lines}{fig:featureid-3d-aortaidentification-region}{h}
%---

\noindent As with ribs identification, branch node filtering on its own is generally insufficient when identifying the aorta.
