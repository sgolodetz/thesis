...
\end{tabular}
\end{center}
\caption{Quantifying the extent to which subjectivity problems can affect validation, by comparing the results of manually segmenting the set of slices from the BT-2 case study on two separate occasions}
