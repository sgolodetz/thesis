...
- Fairly good (Dice = 0.859), but automated result floods out into another blood vessel slightly -- which one, and why?
...
- Missed the lateral segment of the left lobe -- why? (probably because we find a single seed and flood from it, but the pieces are disconnected in the slices we've chosen)
- Floods beyond the correct boundary in the direction of the aorta -- why? (probably due to weak edges)
