...
\caption{MC-2's left kidney shares a weak edge with an adjoining tumour (a) -- this leads to a less than perfect segmentation of the image (b), and causes the automated identifier to oversegment the left kidney}
...
\caption{The automated result for MC-2's right kidney chooses to include the renal pelvis, whilst the gold standard chooses not to include it}
