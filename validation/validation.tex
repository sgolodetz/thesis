...
\begin{stusubfig}{p}
	\subfigure[]
	{\includegraphics[width=.45\linewidth]{validation/validation-SD-2-70-90-kidneysdifference-a.png}}%
	%
	\hspace{4mm}%
	%
	\subfigure[]
	{\includegraphics[width=.45\linewidth]{validation/validation-SD-2-70-90-kidneysdifference-b.png}}%
...
\label{fig:validation-SD-2-70-90-kidneysdifference}
\end{stusubfig}
%---
