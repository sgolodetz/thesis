...
%---
\stufigex{height=4cm}{appendixds/appendixds-dsf-representation.png}{An example disjoint set forest, representing the partitioning of the set $\{A \ldots L\}$ into disjoint subsets $\{A,B,C,E\}$, $\{D,F,G,H,I\}$, $\{K,L\}$ and $\{J\}$}{fig:appendixds-dsf-representation}{p}
%---
...
\begin{stusubfig}{p}
	...
	{\includegraphics[height=4cm]{appendixds/appendixds-dsf-unionexample-before.png}}%
	%
	\hspace{4mm}%
	%
	\subfigure[Making C the child of B]
	{\includegraphics[height=4cm]{appendixds/appendixds-dsf-unionexample-after1.png}}%
	%
	\hspace{4mm}%
	%
	\subfigure[Making B the child of C]
	{\hspace{4mm}\includegraphics[height=5.5cm]{appendixds/appendixds-dsf-unionexample-after2.png}\hspace{4mm}}%
...
\begin{stusubfig}{p}
	\subfigure[The initial forest]
	{\includegraphics[height=5.5cm]{appendixds/appendixds-dsf-findsetexample-before.png}}%
	%
	\hspace{4mm}%
	%
	\subfigure[After FIND-SET(E)]
	{\includegraphics[height=4cm]{appendixds/appendixds-dsf-findsetexample-after.png}}%
